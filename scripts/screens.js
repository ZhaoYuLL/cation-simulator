...
LEVEL_DATA = [
    //level one
    `w=600 h=600 x=300 y=300 cw=400 ch=400 px=300 py=480 pm=0.005 pq=0.005 res=30 th=0.1
    WB 210 120 50 50
    PC 200 300 0.00025
    PC 400 300 -0.00025`,
    //level two
    ...
    WB 210 120 50 50`,
    //level three
    `w=1200 h=1200 x=600 y=300 cw=600 ch=600 px=600 py=1100 pm=0.005 pq=0.005 res=45 th=0.25
    PC 300 300 0.0005
    PC 900 300 -0.0005
    PC 300 900 -0.0005
    PC 900 900 0.0005
    WB 25 25 50 50`,
    //level four
    `w=1200 h=1200 x=600 y=600 cw=600 ch=600 px=600 py=1100 pm=0.005 pq=0.005 res=45 th=0
    PC 300 300 0.0005
    PC 300 400 0.0005
    PC 900 300 -0.0005
    PC 900 400 -0.0005
